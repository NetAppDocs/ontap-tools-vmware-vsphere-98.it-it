...
sidebar: sidebar 
keywords:  
summary: È possibile impostare timeout e altri valori sugli host ESXi utilizzando i tool ONTAP® per VMware vSphere per garantire le migliori performance e il failover di successo. I valori impostati da Virtual Storage Console sono basati su test interni NetApp. 
---
...
[role="lead"]
È possibile impostare timeout e altri valori sugli host ESXi utilizzando i tool ONTAP® per VMware vSphere per garantire le migliori performance e il failover di successo. I valori impostati dalla console di storage virtuale (VSC) si basano su test NetApp interni.
